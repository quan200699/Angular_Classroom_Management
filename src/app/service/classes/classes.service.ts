...
export class ClassesService {
  ...
  getAllTutorHasFreeTime(id: number, classTime: string, jobId: number): Observable<Lecture[]> {
    return this.http.get<Lecture[]>(API_URL + `/classes/${id}/tutors?classTime=` + classTime + '&jobId=' + jobId);
  }
}
