...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["program-program-module"], {
    ...
    var CreateProgramComponent = /*#__PURE__*/function () {
      ...
      _createClass(CreateProgramComponent, [{
        ...
        value: function createProgram() {
          ...
          if (program.name !== "") {
            this.programService.createProgram(program).subscribe(function () {
              $(function () {
  ...
  function srcAppProgramListProgramListProgramComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ListProgramComponent = /*#__PURE__*/function () {
      function ListProgramComponent(programService) {
      ...
      _createClass(ListProgramComponent, [{
        ...
        key: "getProgramId",
        value: function getProgramId(id) {
          this.id = id;
        }
      }, {
        key: "deleteProgram",
        value: function deleteProgram() {
          ...
          this.programService.deleteProgram(this.id).subscribe(function () {
            _this4.programService.getAllProgram().subscribe(function (listProgram) {
              _this4.listProgram = listProgram;
            });
        ...
        value: function getAllProgram() {
          ...
          this.programService.getAllProgram().subscribe(function (listProgram) {
            _this5.listProgram = listProgram;
            $(function () {
  ...
  function srcAppProgramProgramRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _create_program_create_program_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./create-program/create-program.component */
    "./src/app/program/create-program/create-program.component.ts");
    /* harmony import */


    var _edit_program_edit_program_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
  ...
  function srcAppProgramProgramModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _program_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./program-routing.module */
    "./src/app/program/program-routing.module.ts");
    /* harmony import */


    var _list_program_list_program_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./list-program/list-program.component */
    "./src/app/program/list-program/list-program.component.ts");
    /* harmony import */
    ...
    ProgramModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_list_program_list_program_component__WEBPACK_IMPORTED_MODULE_4__["ListProgramComponent"], _create_program_create_program_component__WEBPACK_IMPORTED_MODULE_5__["CreateProgramComponent"], _edit_program_edit_program_component__WEBPACK_IMPORTED_MODULE_7__["EditProgramComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _program_routing_module__WEBPACK_IMPORTED_MODULE_3__["ProgramRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"]]
    })], ProgramModule);
    /***/
  }
}]);
