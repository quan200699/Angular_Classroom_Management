...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["student-student-module"], {
  ...
  function srcAppStudentEditStudentEditStudentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EditStudentComponent = /*#__PURE__*/function () {
      function EditStudentComponent(activatedRoute, studentService, classesService) {
        var _this = this;
      ...
      _createClass(EditStudentComponent, [{
        ...
        value: function getAllClasses() {
          ...
          this.classesService.getAllClasses().subscribe(function (listClasses) {
            _this2.listClasses = listClasses;
          });
        }
      }, {
        key: "getStudentInfo",
        value: function getStudentInfo(id) {
          ...
          this.studentService.getStudent(id).subscribe(function (student) {
            _this3.name = student.name;
            _this3.id = student.id;
            _this3.studentId = student.studentId;
            _this3.currentClass = student.classes;
          });
        }
      }, {
        key: "updateStudent",
  ...
  function srcAppStudentStudentModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    StudentModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_edit_student_edit_student_component__WEBPACK_IMPORTED_MODULE_4__["EditStudentComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _student_routing_module__WEBPACK_IMPORTED_MODULE_3__["StudentRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"]]
    })], StudentModule);
    /***/
  }
}]);
